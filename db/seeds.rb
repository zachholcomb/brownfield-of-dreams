...
User.create!(email: 'admin2@example.com', first_name: 'Tiff', last_name: 'B', password:  "password", role: :admin, token: "fakeToken", github_user: "tiffanybacher", github_id: 1234567)
